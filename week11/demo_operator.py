...
btn_add = Button(window, text="Add", width=10, command = btn_add_click)
btn_add.grid(row = 4, column =1, sticky=W)

btn_sub = Button(window, text="Subtract", width=10, command = btn_sub_click)
btn_sub.grid(row = 4, column =2, sticky=W)

btn_multi = Button(window, text="Multiple", width=10, command = btn_multi_click)
btn_multi.grid(row = 5, column =1, sticky=W)

btn_divide = Button(window, text="Divide", width=10, command = btn_divide_click)
